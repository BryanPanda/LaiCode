...
// Determine if there exists a path (the path can only be from one node
// to itself or to any of its descendants), the sum of the numbers on the
// path is the given target number.
...
public class BinaryTreePathSumToTarget {
	...
	public static void main(String[] args) {
		...
		System.out.println(binaryTreePathSumToTarget.exist(root, -7));
	}
